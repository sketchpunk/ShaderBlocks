...
function init(canvas,bgColor="#000000",wp=1,hp=1){
	//........................................
	//Get Context
	...
	//fitScreen(wp,hp);							//Set the size of the canvas to a percent of the screen
	setClearColor(bgColor);				//Set clear color
...
//Shaders
//------------------------------------------------------
function createProgramFromText(vShaderTxt,fShaderTxt,doValidate,transFeedbackVars=null){
...
function createProgram(vShader,fShader,doValidate,transFeedbackVars=null){
	...
	if(transFeedbackVars != null) ctx.transformFeedbackVaryings(prog, transFeedbackVars, ctx.SEPARATE_ATTRIBS); //INTERLEAVED_ATTRIBS
